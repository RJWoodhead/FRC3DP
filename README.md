...
with an emphasis on using basic 3D-printed parts wherever possible. The idea is to provide the community with a set
...
* [Compendium of Useful Parts](Useful/Useful.md) - a variety of miscellaneous parts, such as drill guides, shaft collars and couplers, and mounts for various common FRC components.
...
* [CheapElevator](CheapElevator/CheapElevator.md) - my spin on the classic GreyT multistage elevator mechanism. 
...
Unless otherwise noted, all the parts can be printed without support; there may be cosmetic issues on overhangs and bridges, but these will not affect the usability of the print; at worst you will have to do a little cleanup with a deburring tool and/or razor knife.
